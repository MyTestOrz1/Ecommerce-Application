 ...
 */
package com.shopizer.ecommerce.security.access;

import org.springframework.security.core.Authentication;

import com.shopizer.ecommerce.security.userdetails.IExtendedUserDetails;
import com.shopizer.ecommerce.security.utils.AuthenticationUtils;
...
public interface IPermissionEvaluator {
     ...
     *
     * @param userPrincipal
     *         Authenticated user of type {@link com.shopizer.ecommerce.security.userdetails.IExtendedUserDetails}
     * @param permissionCode
     *         Unique identifier of the permission
     *
     * @return True if the current authenticated user has the permissions for the respective permission code else
