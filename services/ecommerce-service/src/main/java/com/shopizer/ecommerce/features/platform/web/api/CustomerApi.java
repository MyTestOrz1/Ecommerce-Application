...
import com.shopizer.ecommerce.features.platform.web.service.CustomerService;
 ...
 * com.shopizer.ecommerce.features.platform.data.model.persistence.CustomerEntity}.
 *
...
public class CustomerApi extends AbstractApi {
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.CustomerEntity} into the
     * system.
     *
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.CustomerEntity} in the
     * system.
     *
     * @param customerId Unique identifier of Customer in the system, which needs to be updated.
    ...
    public ResponseEntity<Customer> updateCustomer(
        ...
        // Delegate to the service layer.
        final Customer updatedInstance = customerService.updateCustomer(customerId, payload);
    ...
    public ResponseEntity<Customer> findCustomer(
            @PathVariable(name = "customerId") final Integer customerId) {
        // Delegate to the service layer.
        final Customer matchingInstance = customerService.findCustomer(customerId);
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.CustomerEntity} in the system
     ...
     * system.
     *
     * @param customerId Unique identifier of Customer in the system, which needs to be deleted.
     * @return Response of type {@link ResponseEntity} that holds the unique identifier of the
     *     {@link com.shopizer.ecommerce.features.platform.data.model.persistence.CustomerEntity}
    ...
    public ResponseEntity<Integer> deleteCustomer(
            @PathVariable(name = "customerId") final Integer customerId) {
        // Delegate to the service layer.
        final Integer deletedInstance = customerService.deleteCustomer(customerId);
