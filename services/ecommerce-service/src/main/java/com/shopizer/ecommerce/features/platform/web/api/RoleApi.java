...
import com.shopizer.ecommerce.features.platform.web.service.RoleService;
 ...
 * com.shopizer.ecommerce.features.platform.data.model.persistence.RoleEntity}.
 *
...
public class RoleApi extends AbstractApi {
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.RoleEntity} into the system.
     *
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.RoleEntity} in the system.
     *
    ...
    public ResponseEntity<Role> updateRole(
            @PathVariable(name = "roleId") final Integer roleId,
    ...
    public ResponseEntity<Role> findRole(@PathVariable(name = "roleId") final Integer roleId) {
        // Delegate to the service layer.
     ...
     * com.shopizer.ecommerce.features.platform.data.model.persistence.RoleEntity} in the system in
     * a paginated manner.
     *
     ...
     *     {@link com.shopizer.ecommerce.features.platform.data.model.persistence.RoleEntity} that
    ...
    public ResponseEntity<Integer> deleteRole(@PathVariable(name = "roleId") final Integer roleId) {
        // Delegate to the service layer.
        final Integer deletedInstance = roleService.deleteRole(roleId);
