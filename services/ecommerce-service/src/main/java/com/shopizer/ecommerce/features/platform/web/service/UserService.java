...
import com.shopizer.ecommerce.features.platform.data.repository.UserRepository;
...
public class UserService {
    ...
    @Instrument
    @Transactional
    public User addRolesToUser(final Integer userId, final Collection<Integer> ids) {
    ...
    @Instrument
    @Transactional
    public User deleteRolesFromUser(final Integer userId, final Collection<Integer> ids) {
        // 1. Find a matching entity and throw an exception if not found.
        final UserEntity matchingUser = userRepository.findByIdOrThrow(userId);
