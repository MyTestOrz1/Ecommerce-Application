...
public class CustomerService {
    ...
    public Customer updateCustomer(
            final Integer customerId, @Valid final UpdateCustomerRequest payload) {
        // 1. Verify that the entity being updated truly exists.
        final CustomerEntity matchingInstance = customerRepository.findByIdOrThrow(customerId);
    ...
    public Customer findCustomer(final Integer customerId) {
    ...
    @Instrument
    @Transactional
    public Integer deleteCustomer(final Integer customerId) {
        // 1. Delegate to our repository method to handle the deletion.
        return customerRepository.deleteOne(customerId);
    }
}
